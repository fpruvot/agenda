...
lazyFetching:true,startParam:"D&eacute;but",endParam:"Fin",titleFormat:{month:"MMMM yyyy",week:"'Du' d[ yyyy]{ 'au'[ MMM] d MMMM yyyy}",day:"dddd dd MMMM yyyy"},columnFormat:{month:"ddd",week:"dddd dd",day:"dd/MM/yyyy"},timeFormat:{"":"H(:mm)"},isRTL:false,firstDay:0,monthNames:["Janvier","F&eacute;vrier","Mars","Avril","Mai","Juin","Juillet","Août","Septembre","Octobre","Novembre","D&eacute;cembre"],monthNamesShort:["Jan","Feb","Mar","Apr","Mai","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],dayNames:["Dimanche","Lundi","Mardi",
"Mercredi","Jeudi","Vendredi","Samedi"],dayNamesShort:["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],buttonText:{prev:"",next:"",prevYear:"&nbsp;&lt;&lt;&nbsp;",nextYear:"&nbsp;&gt;&gt;&nbsp;",today:"Aujourd'hui",month:"Mois",week:"Semaine",day:"Jour"},theme:false,buttonIcons:{prev:"circle-triangle-w",next:"circle-triangle-e"},unselectAuto:true,dropAccept:"*"},xc={header:{left:"next,prev today",center:"",right:"title"},buttonText:{prev:"&nbsp;&#9658;&nbsp;",next:"&nbsp;&#9668;&nbsp;",
...
"yyyy-MM-dd'T'HH:mm:ss'Z'")},S:function(a){a=a.getDate();if(a>10&&a<20)return"th";return["st","nd","rd"][a%10-1]||"th"}};Aa.applyAll=$a;Ja.month=mc;Ja.basicWeek=nc;Ja.basicDay=oc;wb({weekMode:"fixed"});Ja.agendaWeek=qc;Ja.agendaDay=rc;wb({allDaySlot:true,allDayText:"Journée",firstHour:6,slotMinutes:30,defaultEventMinutes:120,axisFormat:"H'h'",timeFormat:{agenda:"H:mm{ - H:mm}"},dragOpacity:{agenda:0.5},minTime:00,maxTime:20})})(jQuery);
